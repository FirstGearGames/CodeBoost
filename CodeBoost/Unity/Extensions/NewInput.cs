...
namespace CodeBoost.Extensions
{
    public static class NewInput
    {
        ...
        {
            return (Keyboard is not null) ? Keyboard[key].isPressed : false;
        }
        ...
        {
            return (Keyboard is not null) ? Keyboard[key].wasPressedThisFrame : false;
        }
        ...
        {
            return (Keyboard is not null) ? Keyboard[key].wasReleasedThisFrame : false;
        }
    }
    ...
    public static class InputActionMapExtensions
    {
        ...
        public static float GetAxisRaw(this InputActionMap map, string negativeName, string positiveName, out bool found)
        {
            ...
            if (negativeIa is null || positiveIa is null)
                return 0f;
