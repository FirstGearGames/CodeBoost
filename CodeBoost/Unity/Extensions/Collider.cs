...
namespace CodeBoost.Unity.Extensions
{
    public static class ColliderExtensions
    {
        ...
        public static void GetCapsuleCastParams(this CapsuleCollider capsuleCollider, out Vector3 point1, out Vector3 point2, out float radius)
        {
            ...
            float absX = System.Math.Abs(lossyScale.x);
            float absY = System.Math.Abs(lossyScale.y);
            float absZ = System.Math.Abs(lossyScale.z);
            ...
            switch (capsuleCollider.direction)
            {
                case 1:
                {
                    radius = capsuleCollider.radius * System.Math.Max(absX, absZ);
                ...
                case 2:
                {
                    radius = capsuleCollider.radius * System.Math.Max(absX, absY);
                ...
                default:
                {
                    ...
                    radius = capsuleCollider.radius * System.Math.Max(absY, absZ);
        ...
        public static void GetSphereOverlapParams(this SphereCollider sphereCollider, out Vector3 center, out float radius)
        {
            ...
            float x = System.Math.Abs(lossyScale.x);
            float y = System.Math.Abs(lossyScale.y);
            float z = System.Math.Abs(lossyScale.z);
            ...
            radius = sphereCollider.radius * System.Math.Max(System.Math.Max(x, y), z);
        }
    }
    ...
    public static class Collider2DExtensions
    {
        ...
        public static void GetCircleOverlapParams(this CircleCollider2D circleCollider, out Vector3 center, out float radius)
        {
            ...
            radius = circleCollider.radius * System.Math.Max(System.Math.Max(x, y), z);
        }
    }
}
